...
export interface QBtnDropdown extends Vue {
     ...
     */
    menuAnchor? : 'top left' | 'top middle' | 'top right' | 'center left' | 'center middle' | 'center right' | 'bottom left' | 'bottom middle' | 'bottom right'
    /**
     * Two values setting the menu's own position relative to its target
     */
    menuSelf? : 'top left' | 'top middle' | 'top right' | 'center left' | 'center middle' | 'center right' | 'bottom left' | 'bottom middle' | 'bottom right'
    /**
